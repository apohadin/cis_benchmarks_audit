...
## This script checks for compliance against CIS RHEL Linux 7 Benchmark v2.1.1 2017-01-31 measures
...
help_text() {
    cat  << EOF |fmt -sw99
This script runs tests on the system to check for compliance against the CIS RHEL 7 Benchmarks.
...
outputter() {
    ...
    echo
    echo " CIS RHEL 7 Benchmark v2.2.0 Results "
    echo "---------------------------------------"
